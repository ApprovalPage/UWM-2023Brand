...
lib.ssMetadata = [
		{name:"UWM_nicu_300x600_atlas_1", frames: [[0,0,600,1200],[602,0,600,1200],[0,1202,662,234]]}
];
...
(lib.pic300x600nicu1 = function() {
	this.initialize(ss["UWM_nicu_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.UWM_nicu_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(143.05,437,0.02,1,0,0,0,2.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(142).to({_off:false},0).to({regX:0,scaleX:1.1121,x:143},87,cjs.Ease.quadOut).to({regX:6.1,scaleX:1,x:285.1,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));
	...
	this.instance_5.setTransform(137.05,437,0.02,1,0,0,0,2.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(22).to({_off:false},0).to({regX:0.4,scaleX:0.8108,x:120.3},87,cjs.Ease.quadOut).to({regX:0,scaleX:0.8107,x:203,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_nicu_300x600_atlas_1.jpg?1680211154182", id:"UWM_nicu_300x600_atlas_1"}
	],
	preloads: []
};
