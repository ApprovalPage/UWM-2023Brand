...
lib.ssMetadata = [
		{name:"UWM_nicu_970x250_atlas_1", frames: [[0,0,1940,500],[0,502,1940,500],[0,1004,662,234]]}
];
...
(lib.pic970x250nicu1 = function() {
	this.initialize(ss["UWM_nicu_970x250_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic970x250nicu2 = function() {
	this.initialize(ss["UWM_nicu_970x250_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(149,124.9989,2.0067,0.7143);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.vignette, new cjs.Rectangle(-152,0,602,250), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic970x250nicu2();
	this.instance.setTransform(-545,-125,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.PIC2, new cjs.Rectangle(-545,-125,970,250), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic970x250nicu1();
...
// stage content:
(lib.UWM_nicu_970x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(246).to({_off:false},0).to({x:623},9,cjs.Ease.quadOut).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(126).to({_off:false},0).to({x:623},9,cjs.Ease.quadOut).wait(95).to({regX:-0.1,regY:16.5,x:622.9,y:63.5,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:623,y:47,alpha:0},0).to({_off:true},1).wait(45));

	// underline2
	this.instance_3 = new lib.underline1();
	this.instance_3.setTransform(600,79,0.02,1,0,0,0,2.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:-0.1,scaleX:1.228,x:597.2},94,cjs.Ease.quadOut).to({regX:0,scaleX:1.2281,x:599.95,alpha:0},9).to({_off:true},1).wait(45));

	// HEAD1
	this.instance_4 = new lib.HEAD1();
	this.instance_4.setTransform(1203,47);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({x:623},9,cjs.Ease.quadOut).wait(99).to({regX:-0.8,regY:16.5,x:622.2,y:63.5,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:623,y:47,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_5 = new lib.underline1();
	this.instance_5.setTransform(615,79,0.02,1,0,0,0,2.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0,scaleX:1,x:606},98,cjs.Ease.quadOut).to({x:615,alpha:0},9).to({_off:true},1).wait(165));

	// HEAD skew box
	this.instance_6 = new lib.HEADskewbox();
	this.instance_6.setTransform(1201.05,65.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:621.05},9,cjs.Ease.quadOut).wait(100).to({alpha:0},9).wait(6).to({x:1191.05,alpha:1},0).to({x:621.05},9,cjs.Ease.quadOut).wait(96).to({alpha:0},9).wait(6).to({x:1191.05,alpha:1},0).to({x:621.05},9,cjs.Ease.quadOut).wait(31));

	// BKGD skew box
	this.instance_7 = new lib.BKGDskewbox();
	this.instance_7.setTransform(1168.8,125,1,1,0,0,0,613.8,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(284));

	// vignette
	this.instance_8 = new lib.vignette();
	this.instance_8.setTransform(150,0);
	...
	// stageBackground
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1,3,true).p("EhNVgVFMCarAAAMAAAAqLMiarAAAg");
	this.shape_1.setTransform(485,125);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#999999").s().p("EhNVAVGMAAAgqLMCarAAAMAAAAqLg");
...
p.nominalBounds = new cjs.Rectangle(425,124.5,1357.7,126);
// library properties:
lib.properties = {
