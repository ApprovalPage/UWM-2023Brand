...
lib.ssMetadata = [
		{name:"UWM_nicu_320x480_atlas_1", frames: [[0,0,600,1200],[602,0,600,1200],[0,1202,662,234]]}
];
...
(lib.pic300x600nicu1 = function() {
	this.initialize(ss["UWM_nicu_320x480_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-150,-40,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.PIC1, new cjs.Rectangle(-150,-40,300,600), null);
...
// stage content:
(lib.UWM_nicu_320x480 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(122.05,334,0.02,1,0,0,0,2.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(142).to({_off:false},0).to({regX:0,scaleX:1.0944,x:122},87,cjs.Ease.quadOut).to({scaleX:1,x:260.9,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));
	...
	this.instance_5.setTransform(99.05,334,0.02,1,0,0,0,2.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(22).to({_off:false},0).to({regX:0.3,scaleX:0.8049,x:99.25},87,cjs.Ease.quadOut).to({regX:0,scaleX:0.8047,x:184,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(165));
...
p.nominalBounds = new cjs.Rectangle(-176.9,197.4,1299.6000000000001,442.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_nicu_320x480_atlas_1.jpg?1680211118518", id:"UWM_nicu_320x480_atlas_1"}
	],
	preloads: []
};
