...
lib.ssMetadata = [
		{name:"UWM_nicu_480x320_atlas_1", frames: [[0,0,1940,500],[0,502,1940,500],[0,1004,662,234]]}
];
...
(lib.pic970x250nicu1 = function() {
	this.initialize(ss["UWM_nicu_480x320_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.PIC2, new cjs.Rectangle(-70,0,970,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(507,0,0.5,0.5,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.PIC1, new cjs.Rectangle(-463,0,970,250), null);
...
// stage content:
(lib.UWM_nicu_480x320 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(126).to({_off:false},0).to({x:245},9,cjs.Ease.quadOut).wait(95).to({regX:-0.1,regY:16.5,x:258.2,y:272.75,alpha:0.8097},0).wait(1).to({x:271.15,alpha:0.6246},0).wait(1).to({x:282.65,alpha:0.4602},0).wait(1).to({x:292.2,alpha:0.3238},0).wait(1).to({x:299.75,alpha:0.2159},0).wait(1).to({x:305.55,alpha:0.1334},0).wait(1).to({x:309.8,alpha:0.0722},0).wait(1).to({x:312.85,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:315,y:256.25,alpha:0},0).to({_off:true},1).wait(45));

	// underline2
	this.instance_2 = new lib.underline1();
	this.instance_2.setTransform(246,288.25,0.02,1,0,0,0,2.5,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:-0.1,scaleX:1.228,x:239.55},94,cjs.Ease.quadOut).to({regX:0,scaleX:1.2281,x:315,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).to({x:237},9,cjs.Ease.quadOut).wait(98).to({scaleX:1.0001},0).wait(1).to({regX:-0.8,regY:16.5,x:243.4,y:272.75,alpha:0.8097},0).wait(1).to({x:250.4,alpha:0.6246},0).wait(1).to({scaleX:1,x:256.65,alpha:0.4602},0).wait(1).to({x:261.85,alpha:0.3238},0).wait(1).to({x:265.95,alpha:0.2159},0).wait(1).to({x:269.05,alpha:0.1334},0).wait(1).to({x:271.4,alpha:0.0722},0).wait(1).to({x:273.05,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:275,y:256.25,alpha:0},0).to({_off:true},1).wait(165));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:0,scaleX:1.0107,x:234.65},98,cjs.Ease.quadOut).to({scaleX:1.0105,x:283.95,alpha:0},9).to({_off:true},1).wait(165));
	...
	this.instance_7.setTransform(559.8,355,1,1,0,0,0,613.8,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(232).to({_off:false},0).wait(52));
...
p.nominalBounds = new cjs.Rectangle(-223,160,1396.7,320);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_nicu_480x320_atlas_1.jpg?1680211099366", id:"UWM_nicu_480x320_atlas_1"}
	],
	preloads: []
};
