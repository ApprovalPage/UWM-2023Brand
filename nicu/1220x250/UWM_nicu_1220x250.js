...
lib.ssMetadata = [
		{name:"UWM_nicu_1220x250_atlas_1", frames: [[0,0,2440,500],[0,502,2440,500],[0,1004,662,234]]}
];
...
(lib.pic1220x250nicu1 = function() {
	this.initialize(ss["UWM_nicu_1220x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.UWM_nicu_1220x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:-0.4,scaleX:1.193,x:842.8},94,cjs.Ease.quadOut).to({regX:0,x:843.95,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0,scaleX:1.0105,x:854.7},98,cjs.Ease.quadOut).to({x:861.95,alpha:0},9).to({_off:true},1).wait(165));
...
p.nominalBounds = new cjs.Rectangle(609.4,119,1423.3000000000002,131.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_nicu_1220x250_atlas_1.jpg?1680210843955", id:"UWM_nicu_1220x250_atlas_1"}
	],
	preloads: []
};
