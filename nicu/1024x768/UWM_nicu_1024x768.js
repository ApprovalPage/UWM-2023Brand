...
lib.ssMetadata = [
		{name:"UWM_nicu_1024x768_atlas_1", frames: [[0,0,2048,1536],[0,1538,2048,1536],[0,3076,662,234]]}
];
...
(lib.pic1024x768nicu1 = function() {
	this.initialize(ss["UWM_nicu_1024x768_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic1024x768nicu2 = function() {
	this.initialize(ss["UWM_nicu_1024x768_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1024x768nicu2();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1024x768nicu1();
	this.instance.setTransform(0,0,0.5,0.5);
...
// stage content:
(lib.UWM_nicu_1024x768 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(126).to({_off:false},0).to({x:486.65},9,cjs.Ease.quadOut).wait(95).to({regX:-0.1,regY:16.5,x:521.45,y:667.2,alpha:0.8097},0).wait(1).to({x:555.5,alpha:0.6246},0).wait(1).to({x:585.75,alpha:0.4602},0).wait(1).to({x:610.85,alpha:0.3238},0).wait(1).to({x:630.7,alpha:0.2159},0).wait(1).to({x:645.9,alpha:0.1334},0).wait(1).to({x:657.15,alpha:0.0722},0).wait(1).to({x:665.15,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:670.65,y:632,alpha:0},0).to({_off:true},1).wait(45));

	// underline2
	this.instance_2 = new lib.underline1();
	this.instance_2.setTransform(466.15,700.25,0.0426,2.1333,0,0,0,3.5,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:-0.1,scaleX:2.6245,x:477.75},94,cjs.Ease.quadOut).to({regX:0,x:678,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).to({x:486.65},9,cjs.Ease.quadOut).wait(99).to({regX:-0.8,regY:16.5,x:497.1,y:667.2,alpha:0.8097},0).wait(1).to({x:508.95,alpha:0.6246},0).wait(1).to({x:519.5,alpha:0.4602},0).wait(1).to({x:528.2,alpha:0.3238},0).wait(1).to({x:535.1,alpha:0.2159},0).wait(1).to({x:540.4,alpha:0.1334},0).wait(1).to({x:544.3,alpha:0.0722},0).wait(1).to({x:547.1,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:550.65,y:632,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_4 = new lib.underline1();
	this.instance_4.setTransform(485.15,700.25,0.0426,2.1333,0,0,0,3.5,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:0,scaleX:2.1508,x:485},98,cjs.Ease.quadOut).to({scaleX:2.193,x:590.05,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_nicu_1024x768_atlas_1.jpg?1680210920292", id:"UWM_nicu_1024x768_atlas_1"}
	],
	preloads: []
};
