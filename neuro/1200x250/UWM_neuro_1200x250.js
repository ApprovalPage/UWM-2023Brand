...
lib.ssMetadata = [
		{name:"UWM_neuro_1200x250_atlas_1", frames: [[0,0,2440,500],[0,502,2440,500],[0,1004,662,234]]}
];
...
(lib.pic1220x250neuro01 = function() {
	this.initialize(ss["UWM_neuro_1200x250_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic1220x250neuro02 = function() {
	this.initialize(ss["UWM_neuro_1200x250_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1220x250neuro02();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1220x250neuro01();
	this.instance.setTransform(-485,-125,0.5,0.5);
...
// stage content:
(lib.UWM_neuro_1200x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:0,scaleX:0.8456},94,cjs.Ease.quadOut).to({x:833.9,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0.1,scaleX:0.9755,x:834.2},98,cjs.Ease.quadOut).to({scaleX:0.9754,x:842.05,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_1200x250_atlas_1.jpg?1680720379812", id:"UWM_neuro_1200x250_atlas_1"}
	],
	preloads: []
};
