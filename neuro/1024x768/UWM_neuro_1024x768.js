...
lib.ssMetadata = [
		{name:"UWM_neuro_1024x768_atlas_1", frames: [[0,0,2048,1536],[0,1538,2048,1536],[0,3076,662,234]]}
];
...
(lib.pic1024x768neuro01 = function() {
	this.initialize(ss["UWM_neuro_1024x768_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic1024x768neuro02 = function() {
	this.initialize(ss["UWM_neuro_1024x768_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1024x768neuro02();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1024x768neuro01();
	this.instance.setTransform(0,0,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:-0.1,scaleX:1.8245,x:446.8},94,cjs.Ease.quadOut).to({regX:0,x:567,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:-0.1,scaleX:2.0666,x:444},98,cjs.Ease.quadOut).to({regX:0,scaleX:2.0667,x:510.05,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_1024x768_atlas_1.jpg?1680562899814", id:"UWM_neuro_1024x768_atlas_1"}
	],
	preloads: []
};
