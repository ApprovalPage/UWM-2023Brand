...
lib.ssMetadata = [
		{name:"UWM_neuro_300x600_atlas_1", frames: [[0,0,600,1200],[602,0,600,1200],[0,1202,662,234]]}
];
...
(lib.pic300x600neuro01 = function() {
	this.initialize(ss["UWM_neuro_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(142).to({_off:false},0).to({regX:0.2,scaleX:0.8696,x:124.95},87,cjs.Ease.quadOut).to({regX:0,scaleX:0.8816,x:286.85,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(22).to({_off:false},0).to({regX:0.1,scaleX:1.0535,x:138.1},87,cjs.Ease.quadOut).to({regX:0,scaleX:1.0533,x:225,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_300x600_atlas_1.jpg?1680562859491", id:"UWM_neuro_300x600_atlas_1"}
	],
	preloads: []
};
