...
lib.ssMetadata = [
		{name:"UWM_neuro_768x1024_atlas_1", frames: [[0,0,1536,2048],[1538,0,1536,2048],[0,2050,662,234]]}
];
...
(lib.pic768x1024neuro01 = function() {
	this.initialize(ss["UWM_neuro_768x1024_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic768x1024neuro02 = function() {
	this.initialize(ss["UWM_neuro_768x1024_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic768x1024neuro02();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic768x1024neuro01();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(142).to({_off:false},0).to({regX:0.4,scaleX:1.8102,x:354.3},87,cjs.Ease.quadOut).to({regX:0,scaleX:1.81,x:779,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(22).to({_off:false},0).to({regX:-0.1,scaleX:2.2,x:400.8},87,cjs.Ease.quadOut).to({regX:0,x:637.5,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_768x1024_atlas_1.jpg?1680562889502", id:"UWM_neuro_768x1024_atlas_1"}
	],
	preloads: []
};
