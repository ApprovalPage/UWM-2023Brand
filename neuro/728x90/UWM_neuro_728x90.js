...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic728x90neuro01();
	this.instance.setTransform(0,0,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:0.4,scaleX:0.8491,x:534.35},94,cjs.Ease.quadOut).to({regX:0,x:533.9,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:0.1,scaleX:0.9684,x:533.1},98,cjs.Ease.quadOut).to({x:534.05,alpha:0},9).to({_off:true},1).wait(165));

	// HEAD skew box
	this.instance_5 = new lib.HEADskewbox();
	this.instance_5.setTransform(586.05,44.75);
