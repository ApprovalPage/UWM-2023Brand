...
lib.ssMetadata = [
		{name:"UWM_neuro_970x250_atlas_1", frames: [[0,0,1940,500],[0,502,1940,500],[0,1004,662,234]]}
];
...
(lib.pic970x250neuro01 = function() {
	this.initialize(ss["UWM_neuro_970x250_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:0.2,scaleX:0.8491,x:604.15},94,cjs.Ease.quadOut).to({regX:0.1,x:604,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({x:623},9,cjs.Ease.quadOut).wait(99).to({regX:-0.1,regY:16.5,x:622.9,y:63.5,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:623,y:47,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_5 = new lib.underline1();
	this.instance_5.setTransform(612,79,0.02,1,0,0,0,2.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0.1,scaleX:0.9649,x:602.7},98,cjs.Ease.quadOut).to({regX:0,x:611.95,alpha:0},9).to({_off:true},1).wait(165));
