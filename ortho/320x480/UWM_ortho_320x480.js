...
lib.ssMetadata = [
		{name:"UWM_ortho_320x480_atlas_1", frames: [[0,0,600,1200],[602,0,600,1200],[0,1202,662,234]]}
];
...
(lib.pic300x600ortho1 = function() {
	this.initialize(ss["UWM_ortho_320x480_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.rf(["#FFFFFF","#000000"],[0,1],0,0,0,0,0,189.6).s().p("A4/bWMAAAg2rMAx/AAAMAAAA2rg");
...
}).prototype = getMCSymbolPrototype(lib.vignette, new cjs.Rectangle(-160,0,320,350), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(119).to({_off:false},0).to({x:54,alpha:1},23,cjs.Ease.quintOut).wait(87).to({x:204,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));
	...
	this.instance_9.setTransform(160.05,0,1,1.06,0,0,0,0.1,0);
	this.instance_9.alpha = 0.8008;
	this.instance_9.compositeOperation = "multiply";

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({regX:0,scaleX:1.06,x:160,alpha:0},66).wait(52).to({regX:0.1,scaleX:1,x:160.1},0).to({alpha:0.8008},7).wait(3).to({regX:0,x:160},0).to({regX:0.1,x:160.1,alpha:0},64).to({_off:true},1).wait(91));
