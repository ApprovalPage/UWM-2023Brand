...
lib.ssMetadata = [
		{name:"UWM_ortho_1220x250_atlas_1", frames: [[0,0,2440,500],[0,502,2440,500],[0,1004,662,234]]}
];
...
(lib.pic1220x250ortho1 = function() {
	this.initialize(ss["UWM_ortho_1220x250_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic1220x250ortho2 = function() {
	this.initialize(ss["UWM_ortho_1220x250_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1220x250ortho2();
...
// stage content:
(lib.UWM_ortho_1220x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:1.1,scaleX:0.6561,x:859.5},94,cjs.Ease.quadOut).to({regX:0.3,scaleX:0.6526,x:860.75,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({x:873},9,cjs.Ease.quadOut).wait(99).to({regX:-0.8,regY:16.4,x:872.2,y:63.4,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:873,y:47,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_5 = new lib.underline1();
	this.instance_5.setTransform(864,79,0.02,1,0,0,0,2.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0.1,scaleX:1.0035,x:855.6},98,cjs.Ease.quadOut).to({regX:0,x:854,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_ortho_1220x250_atlas_1.jpg?1680045849385", id:"UWM_ortho_1220x250_atlas_1"}
	],
	preloads: []
};
