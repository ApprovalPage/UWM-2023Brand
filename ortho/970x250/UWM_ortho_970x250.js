...
lib.ssMetadata = [
		{name:"UWM_ortho_970x250_atlas_1", frames: [[0,0,1940,500],[0,502,1940,500],[0,1004,662,234]]}
];
...
(lib.pic970x250ortho1 = function() {
	this.initialize(ss["UWM_ortho_970x250_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(126).to({_off:false},0).to({x:623},9,cjs.Ease.quadOut).wait(95).to({regX:-1.1,regY:16.5,x:621.9,y:63.5,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:623,y:47,alpha:0},0).to({_off:true},1).wait(45));

	// underline2
	this.instance_3 = new lib.underline1();
	this.instance_3.setTransform(604,79,0.02,1,0,0,0,2.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:0.5,scaleX:0.6631,x:609.3},94,cjs.Ease.quadOut).to({regX:0.1,x:610.05,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({x:623},9,cjs.Ease.quadOut).wait(99).to({regX:-0.8,regY:16.4,x:622.2,y:63.4,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:623,y:47,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_5 = new lib.underline1();
	this.instance_5.setTransform(614,79,0.02,1,0,0,0,2.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0,scaleX:1.007,x:605.25},98,cjs.Ease.quadOut).to({x:603.95,alpha:0},9).to({_off:true},1).wait(165));
...
p.nominalBounds = new cjs.Rectangle(483,124.5,1299.7,126);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_ortho_970x250_atlas_1.jpg?1680045412528", id:"UWM_ortho_970x250_atlas_1"}
	],
	preloads: []
};
