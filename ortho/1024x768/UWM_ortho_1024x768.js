...
lib.ssMetadata = [
		{name:"UWM_ortho_1024x768_atlas_1", frames: [[0,0,2048,1536],[0,1538,2048,1536],[0,3076,662,234]]}
];
...
(lib.pic1024x768ortho1 = function() {
	this.initialize(ss["UWM_ortho_1024x768_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic1024x768ortho2 = function() {
	this.initialize(ss["UWM_ortho_1024x768_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1024x768ortho2();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1024x768ortho1();
	this.instance.setTransform(0,0,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(126).to({_off:false},0).to({x:486.65},9,cjs.Ease.quadOut).wait(95).to({regX:-1.1,regY:16.5,x:496.45,y:667.2,alpha:0.8097},0).wait(1).to({x:508.3,alpha:0.6246},0).wait(1).to({x:518.85,alpha:0.4602},0).wait(1).to({x:527.55,alpha:0.3238},0).wait(1).to({x:534.45,alpha:0.2159},0).wait(1).to({x:539.75,alpha:0.1334},0).wait(1).to({x:543.65,alpha:0.0722},0).wait(1).to({x:546.45,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:550.65,y:632,alpha:0},0).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:0.1,scaleX:1.4421,x:451.75},94,cjs.Ease.quadOut).to({regX:0,x:553.55,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).to({x:486.65},9,cjs.Ease.quadOut).wait(99).to({regX:-0.8,regY:16.4,x:497.1,y:667,alpha:0.8097},0).wait(1).to({x:508.95,alpha:0.6246},0).wait(1).to({x:519.5,alpha:0.4602},0).wait(1).to({x:528.2,alpha:0.3238},0).wait(1).to({x:535.1,alpha:0.2159},0).wait(1).to({x:540.4,alpha:0.1334},0).wait(1).to({x:544.3,alpha:0.0722},0).wait(1).to({x:547.1,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:550.65,y:632,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_4 = new lib.underline1();
	this.instance_4.setTransform(450.25,700.25,0.0426,2.1333,0,0,0,3.5,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:-0.2,scaleX:2.1578,x:447.7},98,cjs.Ease.quadOut).to({regX:0,scaleX:2.1579,x:510.1,alpha:0},9).to({_off:true},1).wait(165));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(228).to({_off:false},0).wait(56));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_ortho_1024x768_atlas_1.jpg?1680045687871", id:"UWM_ortho_1024x768_atlas_1"}
	],
	preloads: []
};
