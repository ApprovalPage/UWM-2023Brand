...
lib.ssMetadata = [
		{name:"UWM_ortho_728x90_atlas_1", frames: [[0,0,1456,180],[0,182,1456,180],[0,364,662,234]]}
];
...
(lib.pic728x90ortho1 = function() {
	this.initialize(ss["UWM_ortho_728x90_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic728x90ortho2 = function() {
	this.initialize(ss["UWM_ortho_728x90_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic728x90ortho2();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic728x90ortho1();
	this.instance.setTransform(0,0,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(833,26.25);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:-0.7,scaleX:0.6561,x:539.05},94,cjs.Ease.quadOut).to({regX:0.1,x:540,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).to({x:553},9,cjs.Ease.quadOut).wait(99).to({regX:-0.8,regY:16.4,x:552.2,y:42.65,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:553,y:26.25,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_4 = new lib.underline1();
	this.instance_4.setTransform(538.05,58.25,0.02,1,0,0,0,2.5,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:-0.1,scaleX:1,x:536.9},98,cjs.Ease.quadOut).to({regX:0,x:538,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_ortho_728x90_atlas_1.jpg?1680045102209", id:"UWM_ortho_728x90_atlas_1"}
	],
	preloads: []
};
