...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(1337.55,632,2.1333,2.1333);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(126).to({_off:false},0).to({x:586.65},9,cjs.Ease.quadOut).wait(95).to({regX:0.4,regY:16.5,x:599.65,y:667.2,alpha:0.8097},0).wait(1).to({x:611.5,alpha:0.6246},0).wait(1).to({x:622.05,alpha:0.4602},0).wait(1).to({x:630.75,alpha:0.3238},0).wait(1).to({x:637.65,alpha:0.2159},0).wait(1).to({x:642.95,alpha:0.1334},0).wait(1).to({x:646.85,alpha:0.0722},0).wait(1).to({x:649.65,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:650.65,y:632,alpha:0},0).to({_off:true},1).wait(45));

	// underline2
	this.instance_2 = new lib.underline1();
	this.instance_2.setTransform(546.15,700.25,0.0426,2.1333,0,0,0,3.5,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:0,scaleX:2.1333,x:546.1},94,cjs.Ease.quadOut).to({x:610.1,alpha:0},9).to({_off:true},1).wait(45));

	// HEAD1
	this.instance_3 = new lib.HEAD1();
	this.instance_3.setTransform(1337.55,632,2.1333,2.1333);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).to({x:586.65},9,cjs.Ease.quadOut).wait(99).to({regX:0.4,regY:16.5,x:599.65,y:667.2,alpha:0.8097},0).wait(1).to({x:611.5,alpha:0.6246},0).wait(1).to({x:622.05,alpha:0.4602},0).wait(1).to({x:630.75,alpha:0.3238},0).wait(1).to({x:637.65,alpha:0.2159},0).wait(1).to({x:642.95,alpha:0.1334},0).wait(1).to({x:646.85,alpha:0.0722},0).wait(1).to({x:649.65,alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:650.65,y:632,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_4 = new lib.underline1();
	this.instance_4.setTransform(546.25,700.25,0.0426,2.1333,0,0,0,3.5,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:0,scaleX:2.021,x:546.1},98,cjs.Ease.quadOut).to({scaleX:2.0211,x:610.1,alpha:0},9).to({_off:true},1).wait(165));

	// HEAD skew box
	this.instance_5 = new lib.HEADskewbox();
	this.instance_5.setTransform(868.25,576,2.1333,2.1333);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:593.15},9,cjs.Ease.quadOut).wait(219).to({x:1062.5},13,cjs.Ease.quadInOut).wait(43));
	...
	this.instance_7.setTransform(1501.6,842.65,2.1333,2.1333,0,0,0,613.9,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(228).to({_off:false},0).to({regX:613.8,x:1194.3},9,cjs.Ease.quartInOut).wait(47));
