...
lib.ssMetadata = [
		{name:"UWM_cardio_1200x250_atlas_1", frames: [[0,0,2440,500],[0,502,2440,500],[0,1004,662,234]]}
];
...
(lib.pic1220x250cardiorehab = function() {
	this.initialize(ss["UWM_cardio_1200x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.UWM_cardio_1200x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:0,scaleX:1.0807,x:832.75},94,cjs.Ease.quadOut).to({x:833.95,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0.1,scaleX:1.0456,x:835.1},98,cjs.Ease.quadOut).to({regX:0,x:842,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_cardio_1200x250_atlas_1.jpg?1680280773827", id:"UWM_cardio_1200x250_atlas_1"}
	],
	preloads: []
};
