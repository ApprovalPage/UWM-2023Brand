...
lib.ssMetadata = [
		{name:"UWM_cardio_300x600_atlas_1", frames: [[0,0,600,1200],[602,0,600,1200],[0,1202,662,234]]}
];
...
(lib.pic300x600cardiorehab = function() {
	this.initialize(ss["UWM_cardio_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_7.setTransform(250,392);
	...
	this.instance_8.setTransform(176.8,425.25,1.2331,1.2445,0,0,0,50.1,0.1);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#999999").s().p("EgY/AwcMAAAhg3MAx/AAAMAAABg3g");
...
p.nominalBounds = new cjs.Rectangle(-174,300,1286.7,424);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_cardio_300x600_atlas_1.jpg?1680024163266", id:"UWM_cardio_300x600_atlas_1"}
	],
	preloads: []
};
