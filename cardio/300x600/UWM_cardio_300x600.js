...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(250,394);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(119).to({_off:false},0).to({x:150,alpha:1},23,cjs.Ease.quintOut).wait(87).to({x:300,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));

	// underline2
	this.instance_3 = new lib.underline1();
	this.instance_3.setTransform(153,422,0.02,1,0,0,0,2.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(142).to({_off:false},0).to({regX:0,scaleX:1.04,x:148},87,cjs.Ease.quadOut).to({scaleX:1,x:298,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));

	// HEAD1
	this.instance_4 = new lib.HEAD1();
	this.instance_4.setTransform(250,394);
	...
	this.instance_5.setTransform(149,422,0.02,1,0,0,0,2.5,0);
	...
	this.instance_8.setTransform(200,411.1,1,1.0092,0,0,0,50,0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({alpha:0},66).wait(52).to({alpha:0.6016},7).wait(3).to({alpha:0},60).to({_off:true},1).wait(95));
...
p.nominalBounds = new cjs.Rectangle(-56,300,1168.7,424);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_cardio_300x600_atlas_1.jpg?1679614381828", id:"UWM_cardio_300x600_atlas_1"}
	],
	preloads: []
};
