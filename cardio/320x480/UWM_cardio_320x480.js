...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(119).to({_off:false},0).to({x:160,alpha:1},23,cjs.Ease.quintOut).wait(87).to({x:310,alpha:0},9,cjs.Ease.quintIn).to({_off:true},1).wait(45));
	...
	this.instance_8.setTransform(206,331.1,1,1.0092,0,0,0,50,0.1);
...
p.nominalBounds = new cjs.Rectangle(-40,240,1162.7,400);
// library properties:
lib.properties = {
