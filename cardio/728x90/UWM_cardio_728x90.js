...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(135).to({_off:false},0).to({regX:0.1,scaleX:1.0807,x:533},94,cjs.Ease.quadOut).to({regX:0,x:533.95,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({regX:0.1,scaleX:1.0281,x:533.65},98,cjs.Ease.quadOut).to({x:534.05,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_cardio_728x90_atlas_1.jpg?1680026904862", id:"UWM_cardio_728x90_atlas_1"}
	],
	preloads: []
};
