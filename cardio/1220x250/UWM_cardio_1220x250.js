...
lib.ssMetadata = [
		{name:"UWM_cardio_1220x250_atlas_1", frames: [[0,0,2440,500],[0,502,2440,500],[0,1004,662,234]]}
];
...
(lib.pic1220x250cardiorehab = function() {
	this.initialize(ss["UWM_cardio_1220x250_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pic1220x250cardioscreen = function() {
	this.initialize(ss["UWM_cardio_1220x250_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1220x250cardiorehab();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pic1220x250cardioscreen();
	this.instance.setTransform(-485,-125,0.5,0.5);
...
// stage content:
(lib.UWM_cardio_1220x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape.setTransform(1011.75,125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(284));

	// UWMed logo
	this.instance = new lib.UWMed_logo();
	this.instance.setTransform(1030.65,175.8,0.8264,0.8264,0,0,0,0.4,0.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(284));

	// HEAD3
	this.instance_1 = new lib.HEAD3();
	this.instance_1.setTransform(1443,47);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(246).to({_off:false},0).to({x:873},9,cjs.Ease.quadOut).wait(29));

	// HEAD2
	this.instance_2 = new lib.HEAD2();
	this.instance_2.setTransform(1443,47);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(126).to({_off:false},0).to({x:873},9,cjs.Ease.quadOut).wait(95).to({regX:-0.1,regY:16.5,x:872.9,y:63.5,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:873,y:47,alpha:0},0).to({_off:true},1).wait(45));

	// underline2
	this.instance_3 = new lib.underline1();
	this.instance_3.setTransform(854,79,0.02,1,0,0,0,2.5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:0,scaleX:1.0807,x:852.75},94,cjs.Ease.quadOut).to({x:853.95,alpha:0},9).to({_off:true},1).wait(45));

	// HEAD1
	this.instance_4 = new lib.HEAD1();
	this.instance_4.setTransform(1453,47);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({x:873},9,cjs.Ease.quadOut).wait(99).to({regX:-0.1,regY:16.5,x:872.9,y:63.5,alpha:0.8097},0).wait(1).to({alpha:0.6246},0).wait(1).to({alpha:0.4602},0).wait(1).to({alpha:0.3238},0).wait(1).to({alpha:0.2159},0).wait(1).to({alpha:0.1334},0).wait(1).to({alpha:0.0722},0).wait(1).to({alpha:0.0288},0).wait(1).to({regX:0,regY:0,x:873,y:47,alpha:0},0).to({_off:true},1).wait(165));

	// underline1
	this.instance_5 = new lib.underline1();
	this.instance_5.setTransform(862,79,0.02,1,0,0,0,2.5,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0.1,scaleX:1.0456,x:855.1},98,cjs.Ease.quadOut).to({regX:0,x:862,alpha:0},9).to({_off:true},1).wait(165));

	// HEAD skew box
	this.instance_6 = new lib.HEADskewbox();
	this.instance_6.setTransform(1451.05,65.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:871.05},9,cjs.Ease.quadOut).wait(100).to({alpha:0},9).wait(6).to({x:1441.05,alpha:1},0).to({x:871.05},9,cjs.Ease.quadOut).wait(96).to({alpha:0},9).wait(6).to({x:1441.05,alpha:1},0).to({x:871.05},9,cjs.Ease.quadOut).wait(31));

	// BKGD skew box
	this.instance_7 = new lib.BKGDskewbox();
	this.instance_7.setTransform(1418.8,125,1,1,0,0,0,613.8,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(284));

	// vignette
	this.instance_8 = new lib.vignette();
	this.instance_8.setTransform(152,0);
	...
	this.instance_10.setTransform(485,125);
	...
	// stageBackground
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1,3,true).p("Ehg3gVFMDBvAAAMAAAAqLMjBvAAAg");
	this.shape_1.setTransform(610,125);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#999999").s().p("Ehg3AVGMAAAgqLMDBvAAAMAAAAqLg");
	this.shape_2.setTransform(610,125);
...
p.nominalBounds = new cjs.Rectangle(609.4,124.5,1423.3000000000002,126);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_cardio_1220x250_atlas_1.jpg?1680027055608", id:"UWM_cardio_1220x250_atlas_1"}
	],
	preloads: []
};
