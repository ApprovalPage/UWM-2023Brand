...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({regX:-0.1,scaleX:1.0807,x:602.95},94,cjs.Ease.quadOut).to({regX:0,x:603.95,alpha:0},9).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(11).to({_off:false},0).to({regX:0,scaleX:1,x:603},98,cjs.Ease.quadOut).to({x:612,alpha:0},9).to({_off:true},1).wait(165));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_cardio_970x250_atlas_1.jpg?1680027152864", id:"UWM_cardio_970x250_atlas_1"}
	],
	preloads: []
};
