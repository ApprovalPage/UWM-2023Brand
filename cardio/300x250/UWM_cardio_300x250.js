...
if (reversed == null) { reversed = false; }
	...
	// CTA skew box
	this.instance_6 = new lib.CTAskewbox();
	this.instance_6.setTransform(200,161,1,1,0,0,0,50,0);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(246).to({_off:false},0).to({y:61,alpha:1},23,cjs.Ease.quintOut).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(119).to({_off:false},0).to({alpha:1},9).to({_off:true},149).wait(7));

	// PIC1
	this.instance_8 = new lib.PIC1();
	this.instance_8.setTransform(150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},128).wait(156));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-56,124.5,1168.7,349.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_cardio_300x250_atlas_1.jpg?1678840215988", id:"UWM_cardio_300x250_atlas_1"}
	],
	preloads: []
};
